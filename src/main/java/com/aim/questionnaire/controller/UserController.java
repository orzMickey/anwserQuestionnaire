...
public class UserController {
    ...
    public HttpResponseEntity fuzzySearch(@RequestBody(required = false) Map<String,Object> map){
        ...
        if(pageNum*pageSize<Integer.parseInt(String.valueOf(total))){
            result_search = userService.queryFuzzySearch(username,(pageNum-1)*10,pageSize);
        } else {
            result_search = userService.queryFuzzySearch(username,(pageNum-1)*10,total % pageSize);
        }
